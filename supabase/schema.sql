...
create index if not exists idx_participant_sessions_participant_id
  on public.participant_sessions (participant_id);

create index if not exists idx_participant_sessions_created_at
  on public.participant_sessions (created_at desc);
