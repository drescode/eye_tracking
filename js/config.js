...
function materializeStimulusPage(family, caseDefinition, pageIndex) {
  return {
    ...
    options: caseDefinition.options.map((option, optionIndex) => ({
      ...
      price: option.price || "",
      retailerLabel: option.retailerLabel || "",
      ctaLabel: option.ctaLabel || "ADD TO CART",
      accentColor: option.accentColor || "#D71920",
      accentTextColor: option.accentTextColor || "#ffffff",
        ...
        options: [
          {
            variantId: "koo",
            label: "KOO",
            title: "KOO baked beans pack",
            image: "./pics/11.jpeg",
            productName: "KOO Baked Beans in Tomato Sauce",
            sizeLabel: "400g",
            price: "R17.99",
            retailerLabel: "Checkers Sixty60",
          ...
          },
          {
            ...
            label: "Housebrand",
            title: "Checkers Housebrand baked beans pack",
            image: "./pics/1.jpeg",
            productName: "Checkers Housebrand Baked Beans in Tomato Sauce",
            sizeLabel: "410g",
            price: "R12.99",
            retailerLabel: "Checkers Sixty60",
            ctaLabel: "ADD TO CART",
